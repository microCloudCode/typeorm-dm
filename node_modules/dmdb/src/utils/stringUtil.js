...
var dateUtil_1 = require("./dateUtil"), StringUtil = function() {
    function e() {}
    return e.equalsIgnoreCase = function(r, t) {
        return r && t ? r.toLowerCase() === t.toLowerCase() : r === t;
        ...
        var t = Buffer.alloc(0), n = !1;
        if (0 !== (r = r.trim()).indexOf("0x") && 0 !== r.indexOf("0X") || (r = r.substring(2, r.length)), 
        0 === r.length) return t;
        r.length % 2 != 0 && r.padStart(r.length + 1, "0"), t = Buffer.allocUnsafe(r.length / 2);
        ...
        return e.processQuoteOfName(r, "'");
    }, e.processQuoteOfName = function(r, t) {
        if (!t || !r) return r;
        for (var n, e = r, u = "", f = t.length; -1 !== (n = e.indexOf(t)); ) u += e.substring(0, n + f) + t, 
        e = e.substring(n + f);
        return u += e;
    }, e.array2String = function(r) {
        for (var t = "", n = 0; n < r.length; n++) t += (0 === n ? "" : ", ") + e.escape(r[n]);
        return t;
